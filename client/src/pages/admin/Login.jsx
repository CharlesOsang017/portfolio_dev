  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-950 flex flex-col items-center justify-center px-4 relative">
      ...
      <div className="text-center mb-8 animate-fade-in">
        ...
        <h1 className="text-3xl font-bold font-outfit text-gray-900 dark:text-white">Zenith Admin</h1>
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Professional portfolio management suite</p>
      </div>
      ...
      <div className="w-full max-w-sm bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 p-6 animate-fade-in">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 focus-within:border-indigo-400 dark:focus-within:border-indigo-500 transition-colors">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <button type="button" className="text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition-colors">
                Forgot Password?
              </button>
            </div>
            <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 focus-within:border-indigo-400 dark:focus-within:border-indigo-500 transition-colors">
      ...
      <div className="mt-8 text-center animate-fade-in">
        <div className="flex items-center gap-3 justify-center mb-2">
          ...
          <span className="text-xs tracking-widest text-gray-400 dark:text-gray-500 uppercase font-medium">Secure Environment</span>
          <div className="h-px w-16 bg-gray-300 dark:bg-gray-700"></div>
        </div>
        <p className="text-xs text-gray-400 dark:text-gray-500">© 2024 Zenith Portfolio Admin.</p>
      </div>
    </div>
  );
};
